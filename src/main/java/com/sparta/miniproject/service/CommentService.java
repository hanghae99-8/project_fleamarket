...
import com.sparta.miniproject.jwt.JwtUtil;
...
import static com.sparta.miniproject.entity.UserRoleEnum.ADMIN;
...
public class CommentService {
    ...
    public CommentResponse addComment(Long id, CommentRequest commentRequest, HttpServletRequest request) {
        ...
        if (token != null) {
            ...
            comment.confirmMemo(memoRepository.findById(id).orElseThrow(()->new IllegalArgumentException("게시물이 존재하지 않습니다.")));
